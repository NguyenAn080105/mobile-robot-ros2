...
def generate_launch_description():
    ...
    # Path to the RViz configuration file inside 'mobile_robot' package
    # Ensure you create an 'rviz' folder and save the config as 'lidar_view.rviz' later
    ...
    return LaunchDescription([
        ...
        # Publishes a transform from "map" to "laser_frame" so data can be visualized
