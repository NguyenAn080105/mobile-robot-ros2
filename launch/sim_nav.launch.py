...
def generate_launch_description():
    ...
    # ====================== TIMING ======================
    # Thứ tự quan trọng:
    #   0s  — Gazebo + RSP + EKF (khởi động ngay)
    #   2s  — Spawn robot (chờ Gazebo sẵn sàng)
    #   4.5s  — Laser filter (chờ robot spawn xong, /scan có dữ liệu)
    #   7s  — Nav2 (chờ TF tree đầy đủ: map→odom→base_footprint)
    #   9s  — RViz (chờ Nav2 sẵn sàng để hiện đủ topics)
