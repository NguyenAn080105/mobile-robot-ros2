#!/usr/bin/env python3
"""
navigator_v3.py  ── v3 (4-Command Edition)
==========================================
...
class CheckpointNavigator(Node):
    """
    Navigator v3: 4-command state machine với debug log đầy đủ.
    """
    ...
    def __init__(self):
        ...
        self.get_logger().info(
            f"CheckpointNavigator v3 ready │ "
...
def main(args=None):
    ...
    try:
        ...
        import logging
        logging.getLogger("navigator_v3").error(
